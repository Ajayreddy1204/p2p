...
# # ------------------------------------------------------------
# # invoices.py - Simple static tables (no shaking)
# # ------------------------------------------------------------
...
#         vendor_html += '</tr><tr style="border-bottom: 1px solid #e2e8f0;">'
#         for val in vendor_values:
#             vendor_html += f'<td style="padding: 10px 8px;">{val}</td>'
#         vendor_html += '</tr></table>'
...
#         company_html += '</tr><tr style="border-bottom: 1px solid #e2e8f0;">'
#         for val in company_values:
#             company_html += f'<td style="padding: 10px 8px;">{val}</td>'
#         company_html += '</tr></table>'
