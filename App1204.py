...
#     /* Target any button inside Needs Attention container that has invoice number format */
...
#         height: 100%;
#     }}
#     /* Target the border containers inside columns */
...
# ------------------------------------------------------------
# invoices.py - Tabular format for all sections
# ------------------------------------------------------------
def render_invoice_detail(inv_row: dict, inv_num: str):
    def get_val(key, default=""):
        val = inv_row.get(key, default)
    ...
    st.markdown("### Invoice Summary")
    # Build DataFrame for tabular display
    summary_data = {
